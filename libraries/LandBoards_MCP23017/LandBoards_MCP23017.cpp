...
//	2022-05-24 - Add 8 bit port access to GPIO, OLAT ports
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// void writeOLATA(baData) - Write 8-bits of data at a time
////////////////////////////////////////////////////////////////////////////

void LandBoards_MCP23017::writeOLATA(uint8_t baData)
{
	writeRegister(MCP23017_OLATA,baData);
}

////////////////////////////////////////////////////////////////////////////
// void writeOLATB(baData) - Write 8-bits of data at a time
////////////////////////////////////////////////////////////////////////////

void LandBoards_MCP23017::writeOLATB(uint8_t baData)
{
	writeRegister(MCP23017_OLATB,baData);
}
...
////////////////////////////////////////////////////////////////////////////
// uint8_t readGPIOA(chip) - Read 8-bits at a time
////////////////////////////////////////////////////////////////////////////

uint8_t LandBoards_MCP23017::readGPIOA()
{
	return (readRegister(MCP23017_GPIOA));
}

////////////////////////////////////////////////////////////////////////////
// uint8_t readGPIOB(chip) - Read 8-bits at a time
////////////////////////////////////////////////////////////////////////////

uint8_t LandBoards_MCP23017::readGPIOB()
{
