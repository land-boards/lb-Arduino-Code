...
void LandBoards_Digio128V2::begin(void)
{
  ...
  #error “This library only supports boards with an AVR or SAM processor.”
	...
	for (uint8_t chipNum = 0; chipNum < CHIP_COUNT_D128; chipNum++)	// Set all pins to input by default
	{
		...
		write8(chipNum, MCP23017_IPOLA,0x00);		// Non-inverted input polarity values for card
		...
		write8(chipNum, MCP23017_IPOLB,0x00);		// Non-inverted input polarity values for card
