...
menuStruc menus[] = 
{
  FIRST_LINE_MENU,   "Test DIO16",   1, FIRST_LINE_MENU,  SECOND_LINE_MENU, FIRST_LINE_MENU,  FIRST_LINE_MENU, &testDIGIO16board,  FIRST_LINE_MENU,
  SECOND_LINE_MENU,  "Read EEPROM",  2, FIRST_LINE_MENU,  THIRD_LINE_MENU,  SECOND_LINE_MENU, FIRST_LINE_MENU, &readEEPROM,    FIRST_LINE_MENU,
  THIRD_LINE_MENU,   "Write EEPROM", 3, SECOND_LINE_MENU, FOURTH_LINE_MENU, THIRD_LINE_MENU,  THIRD_LINE_MENU, &writeEEPROM,   FIRST_LINE_MENU,
  FOURTH_LINE_MENU,  "Test MyMenu",  4, THIRD_LINE_MENU,  FOURTH_LINE_MENU, FOURTH_LINE_MENU, FSTL_TESTS_MENU, &nullFcn,       FSTL_TESTS_MENU,
  FSTL_TESTS_MENU,   "Test LEDs",    1, FSTL_TESTS_MENU,  SCND_TESTS_MENU,  FIRST_LINE_MENU,  FSTL_TESTS_MENU, &testLEDsFcn,   FSTL_TESTS_MENU,
  SCND_TESTS_MENU,   "Test Buttons", 2, FSTL_TESTS_MENU,  SCND_TESTS_MENU,  SCND_TESTS_MENU,  SCND_TESTS_MENU, &testButtons,   FSTL_TESTS_MENU
};
