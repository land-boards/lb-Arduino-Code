...
menuStruc menus[] = 
{
  FIRST_LINE_MENU,   "Test OO8",  1, FIRST_LINE_MENU,  SECOND_LINE_MENU, FIRST_LINE_MENU,  FIRST_LINE_MENU, &testOO8,       FIRST_LINE_MENU,
  SECOND_LINE_MENU,  "Write EEP", 2, FIRST_LINE_MENU,  THIRD_LINE_MENU,  SECOND_LINE_MENU, FIRST_SUB_MENU,  &nullFcn,       FIRST_SUB_MENU,
  THIRD_LINE_MENU,   "Read EER",  3, SECOND_LINE_MENU, THIRD_LINE_MENU,  THIRD_LINE_MENU,  THIRD_LINE_MENU, &monTempFcn,    FIRST_LINE_MENU,
};
