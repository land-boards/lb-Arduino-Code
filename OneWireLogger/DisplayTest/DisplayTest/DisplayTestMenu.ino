...
menuStruc menus[] = 
{
  ...
  BACKLITE_MENU,    "Set Backlight Level", 7, MANTIME_MENU,     TSTKPD_MENU,      BACKLITE_MENU,    BACKLITE_MENU,   &setBLt,      STORE_MENU,
  ...
  LOAD_MENU,        "< Load Config",       2, LOAD_MENU,        STORE_MENU,       LOADSTOR_MENU,    LOAD_MENU,       &loadConfig,  LOADSTOR_MENU,
  STORE_MENU,       "Store Config",        3, LOAD_MENU,        STORE_MENU,       STORE_MENU,       STORE_MENU,      &storeConfig, LOADSTOR_MENU,
