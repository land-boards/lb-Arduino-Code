...
//  Only present menu options that match the auto-detected card config
//////////////////////////////////////////////////////////////////////////////////////
...
void otherBoardType(uint8_t i2cDevCount, uint8_t isMCP23017)
{
  ...
  if ((i2cDevCount == 0) || (i2cDevCount == 255))
  {
    ...
    Serial.println(F("6 - OptoFastBi board"));
  }
  Serial.print(F("Select board > "));
  int incomingByte = 0;   // for incoming serial data
...
//////////////////////////////////////////////////////////////////////////////////////
//  void selectMuxBoardType(void) - Mux csrds
//////////////////////////////////////////////////////////////////////////////////////

void selectMuxBoardType(void)
{
  Serial.println(F("Select I2C Mux board type"));
  Serial.println(F("1 - I2C-RPT-01 board"));
  Serial.println(F("2 - I2C-RPT-08 board"));
  Serial.print(F("Select board > "));
  int incomingByte = 0;   // for incoming serial data
