...
menuStruc menus[] = 
{
  FIRST_LINE_MENU,   "Test OptoSmall", 1, FIRST_LINE_MENU,  SECOND_LINE_MENU, FIRST_LINE_MENU,  FIRST_LINE_MENU, &testUUTFcn,  FIRST_LINE_MENU,
  SECOND_LINE_MENU,  "Options",        2, FIRST_LINE_MENU,  THIRD_LINE_MENU,  SECOND_LINE_MENU, FIRST_SUB_MENU,  &nullFcn,     FIRST_SUB_MENU,
  THIRD_LINE_MENU,   "Monitor",        3, SECOND_LINE_MENU, FOURTH_LINE_MENU, THIRD_LINE_MENU,  THIRD_LINE_MENU, &monitorFcn,  FIRST_LINE_MENU,
  FOURTH_LINE_MENU,  "Tests",          4, THIRD_LINE_MENU,  FOURTH_LINE_MENU, FOURTH_LINE_MENU, FSTL_TESTS_MENU, &nullFcn,     FSTL_TESTS_MENU,
  FIRST_SUB_MENU,    "Pullups On",     1, FIRST_SUB_MENU,   SECOND_SUB_MENU,  FIRST_LINE_MENU,  FIRST_SUB_MENU,  &PullupsOn,   FIRST_LINE_MENU,
  SECOND_SUB_MENU,   "Pullups Off",    2, FIRST_SUB_MENU,   THIRD_SUB_MENU,   SECOND_SUB_MENU,  SECOND_SUB_MENU, &PullupsOff,  FIRST_LINE_MENU,
  THIRD_SUB_MENU,    "Don't Invert",   3, SECOND_SUB_MENU,  FOURTH_SUB_MENU,  THIRD_SUB_MENU,   THIRD_SUB_MENU,  &DontInvert,  FIRST_LINE_MENU,
  FOURTH_SUB_MENU,   "Invert",         4, THIRD_SUB_MENU,   FOURTH_SUB_MENU,  FOURTH_SUB_MENU,  FOURTH_SUB_MENU, &DoInvert,    FIRST_LINE_MENU,
