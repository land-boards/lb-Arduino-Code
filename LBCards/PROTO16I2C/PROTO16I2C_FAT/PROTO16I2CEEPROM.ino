//////////////////////////////////////////////////////////
// PROTO16I2CEEPROM: EEPROM Related Code
// Land Boards ODAS format
// Hard coded for PROTO16-I2C Card
//////////////////////////////////////////////////////////
...
// programmed for PROTO16-I2C card
//////////////////////////////////////////////////////////
...
uint8_t eepromCheck(void)
{
  ...
  while ((readBuff[loopv] != 0) && (loopv < 128));
  testStr[loopv - 64] = 0;
  if (strcmp(testStr, "PROTO16-I2C") != 0)
  {
...
// specifically for the PROTO16-I2C card
//////////////////////////////////////////////////////////
...
void eepromWrite(void)
{
  ...
  strcpy(myEep.pstr, "PROTO16-I2C");      // Card Specific code
