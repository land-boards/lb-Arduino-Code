...
// Calibration
// Use piano tuner app on cellphone
// Send C for MIDI Note Middle C (C4) 261 Hz
// Adjust Freq Fine adjust to get as close to 261 Hz as possible
// Send in Note C5, C6, C7
// C5 s/b 2xC4 = ~522 Hz, etc
// Record frequencies
// Adjust value of calb variable up/down until 1V/octave
// HAGIWO had calb = 1.15 which was pretty close, My value ended up at calb = 1.1
// Could be more exact, but OK for now
// 0V = G1 (Note 41) (99 Hz)
// 0.416V = C3 (Note 48)
// 1V = G3
// 1.417V = C4
...
float calb = 1.1;          // Calibration for reduce resistance error
