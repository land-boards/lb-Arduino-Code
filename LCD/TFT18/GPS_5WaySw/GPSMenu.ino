...
menuStruc menus[] = 
{
  MONGPSLOCN_MENU,   "Mon Location",   2, MONGPSLOCN_MENU,   MONGPSCLK_MENU,   MONGPSLOCN_MENU, MONGPSLOCN_MENU,   &readGPS,  MONGPSLOCN_MENU,
  MONGPSCLK_MENU,    "Mon Clock",      3, MONGPSLOCN_MENU,   MANWAYPTS_MENU,   MONGPSCLK_MENU,  MONGPSCLK_MENU,    &GPSClock, MONGPSCLK_MENU,
  MANWAYPTS_MENU,    "Waypoints",      4, MONGPSCLK_MENU,    LOGGING_MENU,     MANWAYPTS_MENU,  GOTOWAYPTS_MENU,   &nullFcn,  GOTOWAYPTS_MENU,
  LOGGING_MENU,      "Logging",        5, MANWAYPTS_MENU,    LOGGING_MENU,     LOGGING_MENU,    STARTLOGGING_MENU, &nullFcn,  STARTLOGGING_MENU,
  GOTOWAYPTS_MENU,   "Go to Waypt",    2, GOTOWAYPTS_MENU,   DOWNLDWAYS_MENU,  MANWAYPTS_MENU,  GOTOWAYPTS_MENU,   &goWays,   GOTOWAYPTS_MENU,
  DOWNLDWAYS_MENU,   "Dl Waypts",      3, GOTOWAYPTS_MENU,   SETACTWAYS_MENU,  MANWAYPTS_MENU,  DOWNLDWAYS_MENU,   &dlWays,   DOWNLDWAYS_MENU,
  SETACTWAYS_MENU,   "Set Act Waypnt", 4, DOWNLDWAYS_MENU,   SHOWWAYPTS_MENU,  MANWAYPTS_MENU,  SETACTWAYS_MENU,   &setWay,   SETACTWAYS_MENU,
  SHOWWAYPTS_MENU,   "Show Waypts",    5, SETACTWAYS_MENU,   SHOWWAYPTS_MENU,  MANWAYPTS_MENU,  SHOWWAYPTS_MENU,   &shWays,   SHOWWAYPTS_MENU,
