...
void OneWireFcn(void) {
  ...
  if ( !ds.search(addr)) {
    Serial.println("No more 1-wire addresses.");
    ds.reset_search();
    delay(250);
    return;
  }
